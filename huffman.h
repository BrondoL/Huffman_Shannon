...
struct MinH *createAndBuildMinHeap(string item, int freq[], int size) {
...
struct MinHNode *buildHfTree(string item, int freq[], int size) {
...
void HuffmanCodes(string item, int freq[], int size) {
